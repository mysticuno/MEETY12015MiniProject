...
move_step_time = 500
food_step_time = 2500
trash_step_time = 3000
power_up_step_time = 2500 #attempt to spawn powerup every 3 seconds
...
def detect_collision():
    ...
    collides_with_trash = snake.pos() in trash_positions#_values
...
#        trash.clearstamp(stamp_id)
        trash_index = trash_positions.index(trash.pos())
        trash.clearstamp(trash_stamps.pop(trash_index))
        trash_positions.pop(trash_index)
